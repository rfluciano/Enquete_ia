...
function testClockAccuracy() {
  ...
  // Test Date.now() twice: first with a looser bound (10 Î¼s) but with a smaller run time to filter out very bad
  // Date.now() performance, and then with a tighter bound (5 Î¼s) to check we have the accuracy we need.
  let times;
